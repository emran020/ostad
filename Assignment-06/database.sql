...
VALUES
    (1, 'Fouad Eman', 'fouafemran@gmail.com', 'New York'),
    (2, 'Lutfun Nahar', 'lutfunnahar@gmail.com', 'Los Angeles'),
    (3, 'Fysal Enan', 'fysalenan@email.com', 'Chicago');
